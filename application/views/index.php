...
<div class="templatemo-welcome" id="kyc-welcome">
    <div class="container">
        <div class="templatemo-slogan text-center container">
            ...
            <p class="txt_slogan"><i>We let you discover new events like <a href="<?php echo(base_url())?>index.php/games/index/Loksabha">Loksabha elections 2014</a>. Vote your candidate to show your support</i></p>
