<div class="templatemo-welcome" id="templatemo-welcome">
    <div class="container">
        <div class="templatemo-slogan text-center">
            <span class="txt_darkgrey">Welcome to </span><span class="txt_orange">Know your canidates</span>
            <p class="txt_slogan"><i>We let you discover new events like Loksabha elections 2014, IPL 2014 etc and candidates. Vote your candidate to show your support</i></p>
...
<div id="templatemo-portfolio" >
    <div class="container">
        <div class="row">
            <div class="templatemo-line-header" >
                <div class="text-center">
                    <hr class="team_hr team_hr_left hr_gray"/><span class="txt_darkgrey"><a href="http://www.mystockphoto.com" title="My Stock Photo" class="txt_darkgrey_strong"  target="_blank">OUR</a> PORTFOLIO</span>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12 contact_right">
                ...
                <form class="form-horizontal" action="#" class="col-md-4">
    ...
    <div class="container">
        <div class="row">
            <div class="text-center">
                ...
                <div class="footer_bottom_content">Copyright © 2014 <a href="#">Know-your-candidates</a></div>
